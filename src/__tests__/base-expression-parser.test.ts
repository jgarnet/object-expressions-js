...
= 5`, {
    ...
    it('should throw SyntaxError when invalid syntax is encountered', async () => {
        await testError('(invalid', new SyntaxError('Expression contains imbalanced symbol: ('));
        await testError(')(', new SyntaxError('Expression contains imbalanced symbol: )'));
        await testError('(invalid))', new SyntaxError('Expression contains imbalanced symbol: )'));
        await testError('LEN(invalid', new SyntaxError('Expression contains imbalanced symbol: ('));
        await testError('LEN(LEN(invalid)', new SyntaxError('Expression contains imbalanced symbol: ('));
        await testError('$a = "invalid', new SyntaxError('Expression contains imbalanced symbol: "'));
        await testError('$a = "invalid""', new SyntaxError('Expression contains imbalanced symbol: "'));
        await testError('$a = MULTIPLY(()', new SyntaxError('Expression contains imbalanced symbol: ('));
        await testError('$status LIKE /test//', new SyntaxError('Expression contains imbalanced symbol: /'));
        await testError('$status LIKE /test', new SyntaxError('Expression contains imbalanced symbol: /'));
        await testError('$status LIKE test/', new SyntaxError('Expression contains imbalanced symbol: /'));
        await testError('$[a = 2', new SyntaxError(`Expression contains imbalanced symbol: [`));
        await testError('] = 2', new SyntaxError(`Expression contains imbalanced symbol: ]`));
        await testError('$] = 2', new SyntaxError(`Expression contains imbalanced symbol: ]`));
        await testError('$][ = 2', new SyntaxError(`Expression contains imbalanced symbol: ]`));
    });
});