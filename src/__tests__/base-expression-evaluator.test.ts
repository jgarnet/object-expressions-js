...
describe('BaseExpressionEvaluator Tests', () => {
    it('should evaluate simple expressions', () => {
        ...
        testAssertion('$a = $b', { a: 1, b: 1}, true);
        testAssertion('$a = $b', { a: 1, b: 2}, false);
    });
...
Care"
    ...
    it('should evaluate expressions with functions', () => {
        ...
        testAssertion('size($a) = add($b, 2)', { a: [1,2,3,4], b: 2 }, true);
    });
    it('should evaluate expressions with regular expressions', () => {
        testAssertion('$url LIKE /\/products\/.*/', { url: '/products/long-sleeve-shirt' }, true);
    });
});